...
for (const payload of [{ laborCostCents: 0 }, { status: "entregado" }, { status: "anulado" }, { paidCents: 1 }]) await denied(equipment.PATCH, { id: 1, version: 1, ...payload });
...
console.log("OK API: solo lectura y técnicos no pueden elevar permisos, cobrar, alterar importes ni cerrar órdenes; recepción no puede anular pagos.");

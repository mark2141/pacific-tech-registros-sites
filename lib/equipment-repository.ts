...
export type EquipmentListQuery = ReturnType<typeof parseEquipmentListQuery> & { scopeMemberId?:number; availableFor?:string };
...
> & {assignedMemberId?:number|null;invoiceKind?:string};
